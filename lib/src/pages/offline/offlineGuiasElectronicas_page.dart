...
class OfflineGuiasElectronicasPage extends StatefulWidget {
  ...
  @override
  State<OfflineGuiasElectronicasPage> createState() => _OfflineGuiasElectronicasPageState();
}

class _OfflineGuiasElectronicasPageState extends State<OfflineGuiasElectronicasPage> {
                  ...
                  trailing: Wrap(
                    ...
                    children: <Widget>[
                      IconButton(
                        ...
                        onPressed: () async {
                          Navigator.pushNamed(context, 'offlineImpresionGuiasElectronicas');
                          _prefs.spGuiaOffline = listaModel[i].id.toString();
